...
export const UserList = () => {
    ...
    return (
        <div className="all">
            {adding ? <Addnewuser setUsers={setUsers} users={users} setAdding={setAdding} adding={adding}/> : ''}
            <div className="userList">
                <UserListHead setAdding={setAdding} adding={adding} />
                <UserListBody users={users} setUsers={setUsers} />
            </div>
        </div>
    )
}